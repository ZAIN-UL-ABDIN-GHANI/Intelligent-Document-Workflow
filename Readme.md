...
This project was designed and developed to demonstrate production-oriented AI engineering skills, including multi-agent orchestration, retrieval-augmented generation (RAG), document intelligence, and end-to-end AI application development.

* Portfolio: zainulabdinghani.vercel.app
* GitHub: github.com/ZAIN-UL-ABDIN-GHANI
* LinkedIn: linkedin.com/in/zain-ul-abdin-ghani

Open to AI Engineer, Machine Learning Engineer, and Generative AI opportunities.
